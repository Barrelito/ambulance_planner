...
class Unit(db.Model):
    ...
    day_time = db.Column(db.String(20), default="07:00-15:00")
    mid_time = db.Column(db.String(20), default="") # <--- NYTT: Mellanpasset (tomt som standard)
    night_time = db.Column(db.String(20), default="22:00-07:00") 
...
class Shift(db.Model):
    ...
    period = db.Column(db.String(10), nullable=False) # "Dag", "Mellan", "Natt"
